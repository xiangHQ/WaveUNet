...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataRootDir', type=str, default=r"./data/interferogram", help="dataset dir")
    ...
    parser.add_argument('--checkpoint', type=str, default=r"./checkpoint/InSAR_Topography.pth", help="checkpoint")
    parser.add_argument('--output_dir', type=str, default=r"./data/WaveUNet", help="output dir")
    parser.add_argument('--output_format', type=str, default='png', choices=['npy', 'mat', 'png'],
